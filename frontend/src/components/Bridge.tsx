...
import { CybersecDeck }        from './CybersecDeck';
    ...
    <div className={`bridge${visible ? ' bridge--visible' : ''}`} role="main">
      ...
      <div className="main-area">
        ...
        <div className="project-bar">
          ...
          {/* Section walkthrough trigger — hidden on cybersec (no section steps) */}
          {page !== 'cybersec' && SECTION_STEPS[page] && (
            <button
        ...
        <div className="page-content mtr-workspace" key={page}>
          ...
          {page === 'cybersec'   && <CybersecDeck onReturn={() => handleNavigate('comms')} />}
      ...
      {visible && page !== 'cybersec' && <SectorMap active={page} onNavigate={handleNavigate} visible={visible} />}

      {/* Build tracker — auto-hidden on Pipeline where the full tracker is visible */}
      {visible && page !== 'cybersec' && (page !== 'pipeline' || pipelineProjects) && <MiniTracker visible={visible} />}
