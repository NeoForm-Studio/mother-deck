...
const SECTORS: Sector[] = ([
  ...
  { id: 'operations', label: 'OPS',      angle:  51, sats: 4, yvar:  18 },
  { id: 'missions',   label: 'LOG',      angle: 103, sats: 3, yvar:  -8 },
  { id: 'inbox',      label: 'INBOX',    angle: 154, sats: 3, yvar:  28 },
  { id: 'pipeline',   label: 'PIPELINE', angle: 206, sats: 4, yvar: -20 },
  { id: 'cybersec',   label: 'CYBERSEC', angle: 257, sats: 5, yvar:  10 },
  { id: 'memory',     label: 'MEMORY',   angle: 309, sats: 3, yvar: -30 },
] as const).map((s, i) => {
